...
import com.project.pastel_pallete.our_live2d.live2ddefine;
...
public class LoadUtil {
	...
	public static Live2DMotion loadAssetsMotion(String path)
	{
		...
		if(live2ddefine.DEBUG_LOG) Log.d("", "モーション読み込み : "+path);
	...
	{
		if(live2ddefine.DEBUG_LOG)Log.d("", "音声読み込み : "+filename);
